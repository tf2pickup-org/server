...
describe('QueuePromptsService', () => {
  ...
  beforeEach(async () => {
    ...
    queueService.slots = [
      { id: 0, gameClass: Tf2ClassName.scout, playerId: players[0]._id, ready: false },
      ...
      { id: 5, gameClass: Tf2ClassName.soldier, playerId: players[1]._id, ready: false },
      ...
      { id: 10, gameClass: Tf2ClassName.medic, playerId: players[2]._id, ready: false },
    ...
    describe('when slots change again', () => {
      beforeEach(async () => new Promise<void>(resolve => {
        queueService.slots = [
          ...
          { id: 4, gameClass: Tf2ClassName.soldier, playerId: null, ready: false },
          { id: 5, gameClass: Tf2ClassName.soldier, playerId: players[1]._id, ready: false },
          { id: 6, gameClass: Tf2ClassName.soldier, playerId: players[2]._id, ready: false },
          { id: 7, gameClass: Tf2ClassName.soldier, playerId: null, ready: false },
          { id: 8, gameClass: Tf2ClassName.demoman, playerId: null, ready: false },
          { id: 9, gameClass: Tf2ClassName.demoman, playerId: null, ready: false },
