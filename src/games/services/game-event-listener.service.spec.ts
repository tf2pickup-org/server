...
describe('GameEventListenerService', () => {
  ...
  describe('should handle game events', () => {
    it('match started', done => {
      const spy = spyOn(gameEventHandlerService, 'onMatchStarted');
    ...
    it('match ended', done => {
      const spy = spyOn(gameEventHandlerService, 'onMatchEnded');
    ...
    it('logs uploaded', done => {
      const spy = spyOn(gameEventHandlerService, 'onLogsUploaded');
    ...
    it('player connected', done => {
      const spy = spyOn(gameEventHandlerService, 'onPlayerJoining');
    ...
    it('player joined team', done => {
      const spy = spyOn(gameEventHandlerService, 'onPlayerConnected');
    ...
    it('player disconnected', done => {
      const spy = spyOn(gameEventHandlerService, 'onPlayerDisconnected');
    ...
    it('score reported', done => {
      const spy = spyOn(gameEventHandlerService, 'onScoreReported');
